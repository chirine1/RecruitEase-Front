...
import HeaderNavContentEmployer from "./HeaderNavContentEmployer";
import { useLocation } from "react-router-dom";
import { axiosPrivate } from "@/axios/axios";
import { logoutUser } from "../logout";

const DashboardEmployerHeaderCustom = () => {
          ...
          <div className="outer-box">
            ...
            <div className="dropdown dashboard-option">
              ...
              <ul className="dropdown-menu">
                <li className="mb-1">
                  <Link
                    to="/employers-dashboard/change-password"
...
export default DashboardEmployerHeaderCustom;
